	...
	public static void mostrarMenu() {
		...
		do {
			...
			case 4:
				...
				while (!salirUsuarios) {
					String[] users = { "Ver usuario", "Agregar usuario", "Actualizar usuario", "Eliminar usuario",
							"Atrás" };
					...
					case 0:
						...
						while (!salirVerUsuarios) {
							...
							int opcUsersID = JOptionPane.showOptionDialog(null, "Menu", null, 0, 3, null, usersID,
									usersID[0]);
							...
							case 0:
								...
								for (Usuario usuario : usuarios) {
									usuariosTexto.append("ID: ").append(usuario.getId_usuario()).append("\n")
											.append("Nombre Completo: ").append(usuario.getNombreCompleto())
											.append("\n").append("Usuario: ").append(usuario.getUser()).append("\n")
											.append("Puesto: ").append(usuario.getPuesto()).append("\n")
											.append("Fecha de Registro: ").append(usuario.getFechaRegistro())
											.append("\n").append("----------------------------\n");
								}
									...
									try {
										...
										if (usuario != null) {
											...
											usuarioTexto.append("ID: ").append(usuario.getId_usuario()).append("\n")
													...
													.append("\n").append("Fecha de Registro: ")
													.append(usuario.getFechaRegistro()).append("\n");

											JOptionPane.showMessageDialog(null, usuarioTexto.toString(),
													"Usuario Encontrado", JOptionPane.INFORMATION_MESSAGE);
											break; // Salir del bucle si se encuentra el usuario
										} else {
											JOptionPane.showMessageDialog(null,
													"Usuario no encontrado. Por favor, ingrese un ID válido.", "Error",
													JOptionPane.ERROR_MESSAGE);
										}
									} catch (NumberFormatException e) {
										JOptionPane.showMessageDialog(null,
												"ID inválido. Por favor, ingrese un número entero.", "Error",
												JOptionPane.ERROR_MESSAGE);
									} catch (Exception e) {
										JOptionPane.showMessageDialog(null,
												"Ocurrió un error inesperado: " + e.getMessage(), "Error",
												JOptionPane.ERROR_MESSAGE);
									}
								}
								break;
					...
					case 1:
						JOptionPane.showMessageDialog(null,
								"Para agregar un nuevo usuario se solicitaran los siguientes datos: "
						...
						int opcionPuesto = JOptionPane.showOptionDialog(null, "Seleccione el puesto en la empresa:",
								"Seleccionar Puesto", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null,
								puestos, puestos[0]);
						...
						controlador.addUser(
								new Usuario(id_usuario, nombreCompleto, user, contraseña, puesto, fechaRegistro));

						break;
					case 2:
						while (true) {
							try {
								String idStr = Usuario
										.pedirInputNoVacio("Ingrese el ID del usuario que desea actualizar:");
								...
								while (actualizar) {
									String[] opcionesActualizar = { "Actualizar Nombre Completo",
											"Actualizar Nombre de Usuario", "Actualizar Puesto", "Atrás" };
									int opcionActualizar = JOptionPane.showOptionDialog(null,
											"Seleccione el campo a actualizar:", "Actualizar Usuario",
											JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null,
											opcionesActualizar, opcionesActualizar[0]);

									switch (opcionActualizar) {
									case 0:
										String nuevoNombreCompleto = Usuario
												.pedirInputNoVacio("Ingrese el nuevo nombre completo:");
										usuarioExistente.setNombreCompleto(nuevoNombreCompleto);
										controlador.updateUser(usuarioExistente);
										JOptionPane.showMessageDialog(null,
												"Nombre completo actualizado exitosamente.");
										break;
									case 1:
										String nuevoUser;
										...
										do {
											nuevoUser = Usuario
													.pedirInputNoVacio("Ingrese el nuevo nombre de usuario:");
									...
									case 2:
										...
										int nuevoPuestoIndex = JOptionPane.showOptionDialog(null,
												...
												JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null,
												nuevosPuestos, usuarioExistente.getPuesto());
										if (nuevoPuestoIndex != -1) {
											...
											JOptionPane.showMessageDialog(null,
													"Debe seleccionar un puesto válido. Inténtelo nuevamente.", "Error",
													JOptionPane.ERROR_MESSAGE);
										}
										break;
									case 3:
								...
								JOptionPane.showMessageDialog(null, "ID inválido. Por favor, ingrese un número entero.",
										"Error", JOptionPane.ERROR_MESSAGE);
							} catch (Exception e) {
